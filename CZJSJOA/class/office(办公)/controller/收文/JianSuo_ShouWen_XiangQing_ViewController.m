...
#import "JianSuo_ShouWen_XiangQing_ViewController.h"
...
@interface JianSuo_ShouWen_XiangQing_ViewController ()<UITextViewDelegate,UIScrollViewDelegate,JianSuo_ViewControllerDelegate,RenWuZhuanXie_SelectMen_TableViewControllerDelegate,LPPopupListViewDelegate,UIWebViewDelegate,DownloadDataDelegate>
...
@implementation JianSuo_ShouWen_XiangQing_ViewController
...
- (void) tianJia_ShuJuDic:(NSDictionary *)dic{
    ...
    self.danWei_Text.text = [self string_JieQuString:self.dic_swdj[@"BLTIME"] NumBer:11];
}
...
-(BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType;
{
    ...
    if( navigationType == UIWebViewNavigationTypeLinkClicked ) {
        ...
        //下载数据，显示数据
        [self.downloadData downloadDataFilePath:str1 VC:self];
         return NO;
    }
