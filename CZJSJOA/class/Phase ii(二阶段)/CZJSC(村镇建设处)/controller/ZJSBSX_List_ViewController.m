...
//
#pragma  mark -- 资金申报事项
#import "ZJSBSX_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface ZJSBSX_List_ViewController ()

@end

@implementation ZJSBSX_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_CZJSC";//查询表名
    self.FLOWNAME = @"czjsc";
    self.PageIndex = @"1";//页数
    self.segueId = @"ZJSBSX";
    //设置参数
