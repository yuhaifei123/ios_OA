//
//  FDCKFQYZZXKJGS_List_ViewController.m
//  CZJSJOA
//
...
#import "FDCKFQYZZXKJGS_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface FDCKFQYZZXKJGS_List_ViewController ()

@end

@implementation FDCKFQYZZXKJGS_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_FDCXKJ";//查询表名
    self.FLOWNAME = @"fdcxkj";
    self.PageIndex = @"1";//页数
    self.segueId = @"FDCKFQYZZXKJGS";
    //设置参数
