//
//  FDCKFQYZZXKBQ_XiangQing_ViewController.m
//  CZJSJOA
//
//  Created by 虞海飞 on 16/5/12.
//  Copyright © 2016年 薛伟俊. All rights reserved.
// 提交选人 AAAA
#pragma  mark -- 房地产开发企业资质许可报签
#import "FDCKFQYZZXKBQ_XiangQing_ViewController.h"
#import "LPPopupListView.h"

@interface FDCKFQYZZXKBQ_XiangQing_ViewController ()<UITextViewDelegate,LPPopupListViewDelegate>
...
/** 相关处室附件 */
@property (weak, nonatomic) IBOutlet Tool_WebView *webView_XGCSFJ;

/** 经办人意见 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_JBRYJ;
/** 处室意见 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_CSLDYJ;
/** 相关业务处室意见 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_XGYWCSYJ;
/** 处室审核 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_CSSHYJ;
/** 局分管领导意见 */
...
@implementation FDCKFQYZZXKBQ_XiangQing_ViewController
...
- (void)viewDidLoad {
    ...
    [self add_GetHttp_PinJie:^NSString *{
        ...
        NSString *string_tableName = @"OA_YWGL_FDCBS";
         NSString *string_flowName = @"fdcbs";
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:
                         ...
                         self.textView_CSLDYJ,@"BMYJ",
                         self.textView_XGYWCSYJ,@"XGBMYJ",
                         self.textView_CSSHYJ,@"BMSH",
                         self.textView_JFGLDYJ,@"LDPS",
                         nil];
    self.array_spyj = [self add_judgeAddTextView_BZDic:dic];

    self.textView_JBRYJ.delegate = self;
    self.textView_CSLDYJ.delegate = self;
    self.textView_CSSHYJ.delegate = self;
...
- (void)add_View_Array:(NSArray *)array{
    ...
    self.textView_CSLDYJ.text = dic_list[@"BMYJ"];
    self.textView_XGYWCSYJ.text = dic_list[@"XGBMYJ"];
    self.textView_CSSHYJ.text = dic_list[@"BMSH"];
    self.textView_JFGLDYJ.text = dic_list[@"LDPS"];
    //附件
    ...
    //附件
    NSString *string_Attachment_BM = [ChangYong_NSObject selectNulString:dic_list[@"BMFJNAME"]];
    [self.webView_XGCSFJ tool_Attachment:string_Attachment_BM];
    [self.webView_XGCSFJ tool_WebViewBrowse:self.navigationController];
}
