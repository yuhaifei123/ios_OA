//
//  JZYQYZZSCYJGS_List_ViewController.m
//  CZJSJOA
//
...
#import "JZYQYZZSCYJGS_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface JZYQYZZSCYJGS_List_ViewController ()

@end

@implementation JZYQYZZSCYJGS_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_JZYSCYJGS";//查询表名
    self.FLOWNAME = @"jzyscyjgs";
    self.PageIndex = @"1";//页数
    self.segueId = @"JZYQYZZSCYJGS";
    //设置参数
