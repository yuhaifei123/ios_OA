//
//  FDCKFQYZZXKBQ_List_ViewController.m
//  CZJSJOA
//
...
#import "FDCKFQYZZXKBQ_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface FDCKFQYZZXKBQ_List_ViewController ()

@end

@implementation FDCKFQYZZXKBQ_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_FDCBS";//查询表名
    self.FLOWNAME = @"fdcbs";
    self.PageIndex = @"1";//页数
    self.segueId = @"FDCKFQYZZXKBQ";
    //设置参数
