//
//  LSZYDLGL_List_ViewController.m
//  CZJSJOA
//
...
#import "LSZYDLGL_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface LSZYDLGL_List_ViewController ()

@end

@implementation LSZYDLGL_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_LSZYDL";//查询表名
    self.FLOWNAME = @"lszydl";
    self.PageIndex = @"1";//页数
    self.segueId = @"LSZYDLGL";
    //设置参数
