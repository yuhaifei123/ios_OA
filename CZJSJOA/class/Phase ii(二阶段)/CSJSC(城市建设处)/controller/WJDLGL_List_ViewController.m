...
//
#pragma  mark -- 挖掘道路管理
#import "WJDLGL_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface WJDLGL_List_ViewController ()

@end

@implementation WJDLGL_List_ViewController
...
- (void)viewDidLoad {
    ...
    [self add_GetHttpData_Functioncode:^NSString *{
        ...
        NSString *stringFun = [NSString stringWithFormat:@"flowname=%@&tablename=%@&typename=dlwj&functionCode=%@",self.FLOWNAME,self.TABLENAME,self.FUNCTIONCODE];
