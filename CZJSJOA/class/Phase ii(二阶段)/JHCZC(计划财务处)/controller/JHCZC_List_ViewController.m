...
#import "JHCZC_List_ViewController.h"

@interface JHCZC_List_ViewController ()

@end

@implementation JHCZC_List_ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    allList_TableViewCell.label_Title.text = [NSString stringWithFormat:@"%@",dic[@"GCMC"]];
