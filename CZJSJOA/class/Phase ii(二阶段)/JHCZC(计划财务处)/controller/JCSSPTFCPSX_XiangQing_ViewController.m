//
//  JCSSPTFCPSX_XiangQing_ViewController.m
//  CZJSJOA
//
...
#import "JCSSPTFCPSX_XiangQing_ViewController.h"
#import "LPPopupListView.h"

@interface JCSSPTFCPSX_XiangQing_ViewController ()<UITextViewDelegate,LPPopupListViewDelegate>

/** 建设单位 */
@property (weak, nonatomic) IBOutlet UILabel *label_JSDW;
/** 工程名称 */
@property (weak, nonatomic) IBOutlet UILabel *label_GCMC;
/** 联系人 */
@property (weak, nonatomic) IBOutlet UILabel *label_LXR;
/** 批文号 */
@property (weak, nonatomic) IBOutlet UILabel *label_PHW;
/** 工程地址 */
@property (weak, nonatomic) IBOutlet UILabel *label_GCDZ;
...
/** 处长意见*/
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_CZYJ;
/** 分批领导批示 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_FPLDPS;
...
@implementation JCSSPTFCPSX_XiangQing_ViewController
...
- (void)viewDidLoad {
    ...
    [self add_GetHttp_PinJie:^NSString *{
        ...
        NSString *string_tableName = @"OA_YWGL_JCPTF";
        NSString *string_flowName = @"jcptf";
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:
                         self.textView_JBRYJ,@"JBR",
                         self.textView_CZYJ,@"CZ",
                         self.textView_FPLDPS,@"FGLDPS",
                         nil];
    self.array_spyj = [self add_judgeAddTextView_BZDic:dic];

    self.textView_JBRYJ.delegate = self;
    self.textView_CZYJ.delegate = self;
    self.textView_FPLDPS.delegate = self;
}
...
- (void)add_View_Array:(NSArray *)array{
    ...
    self.label_GCMC.text = dic_list[@"GCMC"];
    self.label_LXR.text = dic_list[@"LXR"];
    self.label_PHW.text = dic_list[@"PWH"];
    self.label_GCDZ.text = dic_list[@"GCDZ"];

    self.textView_JBRYJ.text = dic_list[@"JBR"];
    self.textView_CZYJ.text = dic_list[@"CZ"];
    self.textView_FPLDPS.text = dic_list[@"FGLDPS"];
