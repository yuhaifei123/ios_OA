//
//  YXKCSJXMSB_XiangQing_ViewController.m
//  CZJSJOA
//
//  Created by 虞海飞 on 16/5/9.
//  Copyright © 2016年 薛伟俊. All rights reserved.
//
#pragma  mark -- 优秀勘察设计项目申报详情
#import "YXKCSJXMSB_XiangQing_ViewController.h"

@interface YXKCSJXMSB_XiangQing_ViewController ()<UITextViewDelegate>
...
/** 专家意见 */
@property (weak, nonatomic) IBOutlet Tool_TextView *tetxView_ZJYJ;
/** 专家意见附件 */
@property (weak, nonatomic) IBOutlet Tool_WebView *webView_ZJYJFJ;
/** 处领导意见 */
...
@implementation YXKCSJXMSB_XiangQing_ViewController
...
- (void)viewDidLoad {
    ...
    [self add_GetHttp_PinJie:^NSString *{
        ...
        NSString *string_tableName = @"OA_YWGL_KCSJSB";
        NSString *string_flowName = @"kcsjsb";
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    self.tetxView_ZJYJ.delegate = self;
...
- (void)add_View_Array:(NSArray *)array{
    ...
    //附件
    NSString *string_Attachment_ZJFJ = [ChangYong_NSObject selectNulString:dic_list[@"ZJFJNAME"]];
    [self.webView_ZJYJFJ tool_Attachment:string_Attachment_ZJFJ];
    [self.webView_ZJYJFJ tool_WebViewBrowse:self.navigationController];
}
