//
//  YXKCSJXMSB_ViewController.m
//  CZJSJOA
//
//  Created by 虞海飞 on 16/5/5.
//  Copyright © 2016年 薛伟俊. All rights reserved.
//
#pragma  mark -- 优秀勘察设计项目申报
#import "YXKCSJXMSB_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface YXKCSJXMSB_List_ViewController ()

@end

@implementation YXKCSJXMSB_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_KCSJSB";//查询表名
    self.FLOWNAME = @"kcsjsb";
    self.PageIndex = @"1";//页数
    self.segueId = @"YXKCSJXMSB";
    //设置参数
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    allList_TableViewCell.label_Title.text = [NSString stringWithFormat:@"%@",dic[@"SBLX"]];
