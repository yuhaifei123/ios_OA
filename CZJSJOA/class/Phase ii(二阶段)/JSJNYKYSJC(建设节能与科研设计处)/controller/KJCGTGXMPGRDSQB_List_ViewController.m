//
//  KJCGTGXMPGRDSQB_List_ViewController.m
//  CZJSJOA
//
...
#import "KJCGTGXMPGRDSQB_List_ViewController.h"

@interface KJCGTGXMPGRDSQB_List_ViewController ()

@end

@implementation KJCGTGXMPGRDSQB_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_KJCGTG";//查询表名
    self.FLOWNAME = @"kjcgtg";
    self.PageIndex = @"1";//页数
    self.segueId = @"KJCGTGXMPGRDSQB";
    //设置参数
