//
//  KCSJQYCXZMGL_XiangQing_ViewController.m
//  CZJSJOA
//
//  Created by 虞海飞 on 16/5/9.
//  Copyright © 2016年 薛伟俊. All rights reserved.
//
#pragma  mark -- 勘察设计企业诚信证明办理
#import "KCSJQYCXZMGL_XiangQing_ViewController.h"

@interface KCSJQYCXZMGL_XiangQing_ViewController ()<UITextViewDelegate>
...
@implementation KCSJQYCXZMGL_XiangQing_ViewController
...
- (void)viewDidLoad {
    ...
    [self add_GetHttp_PinJie:^NSString *{
        ...
        NSString *string_tableName = @"OA_YWGL_KCCXZM";
        NSString *string_flowName = @"kccxzm";
