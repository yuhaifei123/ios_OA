//
//  KCSJQYCXSCGL_ViewController.m
//  CZJSJOA
//
//  Created by 虞海飞 on 16/5/5.
//  Copyright © 2016年 薛伟俊. All rights reserved.
//
#pragma  mark -- 勘察设计企业诚信手册管理
#import "KCSJQYCXSCGL_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface KCSJQYCXSCGL_List_ViewController ()

@end

@implementation KCSJQYCXSCGL_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_KCZZBG";//查询表名
    self.FLOWNAME = @"kczzbg";
    self.PageIndex = @"1";//页数
    self.segueId = @"KCSJQYCXSCGL";
    //设置参数
