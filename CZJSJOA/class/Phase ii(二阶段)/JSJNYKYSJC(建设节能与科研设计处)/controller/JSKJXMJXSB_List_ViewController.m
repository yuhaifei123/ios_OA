//
//  JSKJXMJXSB_List_ViewController.m
//  CZJSJOA
//
...
#import "JSKJXMJXSB_List_ViewController.h"
#import "AllList_TableViewCell.h"
@interface JSKJXMJXSB_List_ViewController ()

@end

@implementation JSKJXMJXSB_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_KJJXSB";//查询表名
    self.FLOWNAME = @"kjjxsb";
    self.PageIndex = @"1";//页数
    self.segueId = @"JSKJXMJXSB";
    //设置参数
