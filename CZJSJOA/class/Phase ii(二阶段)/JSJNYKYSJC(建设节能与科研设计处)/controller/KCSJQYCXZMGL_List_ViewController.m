//
//  KCSJQYCXZMGL_List_ViewController.m
//  CZJSJOA
//
...
#import "KCSJQYCXZMGL_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface KCSJQYCXZMGL_List_ViewController ()

@end

@implementation KCSJQYCXZMGL_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_KCCXZM";//查询表名
    self.FLOWNAME = @"kccxzm";
    self.PageIndex = @"1";//页数
    self.segueId = @"KCSJQYCXZMGL";
    //设置参数
