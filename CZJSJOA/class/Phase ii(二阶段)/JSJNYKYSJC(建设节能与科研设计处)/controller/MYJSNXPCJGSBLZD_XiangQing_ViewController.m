//
//  MYJSNXPCJGSBLZD_XiangQing_ViewController.m
//  CZJSJOA
//
...
#import "MYJSNXPCJGSBLZD_XiangQing_ViewController.h"

@interface MYJSNXPCJGSBLZD_XiangQing_ViewController ()<UITextViewDelegate>

/** 申请单位 */
@property (weak, nonatomic) IBOutlet UILabel *label_SQDW;
/** 申请名称 */
@property (weak, nonatomic) IBOutlet UILabel *label_SQDJ;
/** 联系人 */
...
@implementation MYJSNXPCJGSBLZD_XiangQing_ViewController
...
- (void)viewDidLoad {
    ...
    [self add_GetHttp_PinJie:^NSString *{
        ...
        NSString *string_tableName = @"OA_YWGL_JZNXCP";
        NSString *string_flowName = @"jznxcp";
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:
                         self.textView_BZHDYJ,@"CLSH",
                         self.tetxView_CFGLDYJ,@"KYCYJ",
                         self.tetxView_CLDYJ,@"ZJYJ",
...
- (void)add_View_Array:(NSArray *)array{
    ...
    self.label_SQDJ.text = [self judge_XWLB:dic_list[@"SBDJ"]];

    self.textView_BZHDYJ.text = dic_list[@"CLSH"];
    self.tetxView_CFGLDYJ.text = dic_list[@"KYCYJ"];
    self.tetxView_CLDYJ.text = dic_list[@"ZJYJ"];
