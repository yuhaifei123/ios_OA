//
//  GCJSQYBZSB_List_ViewController.m
//  CZJSJOA
//
...
#import "GCJSQYBZSB_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface GCJSQYBZSB_List_ViewController ()

@end

@implementation GCJSQYBZSB_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_QYBZSB";//查询表名
    self.FLOWNAME = @"qybzsb";//流程名字
    self.PageIndex = @"1";
    self.segueId = @"GCJSQYBZSB";
    //设置参数
