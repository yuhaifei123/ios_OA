//
//  JSLYTGYYJSCSCSBA_XiangQing_ViewController.m
//  CZJSJOA
//
...
#import "JSLYTGYYJSCSCSBA_XiangQing_ViewController.h"

@interface JSLYTGYYJSCSCSBA_XiangQing_ViewController ()<UITextViewDelegate>
/** 申请单位 */
...
/** 推广证编号,有效期 */
@property (weak, nonatomic) IBOutlet UILabel *label_TGZBH;
/** 去往省,市 */
@property (weak, nonatomic) IBOutlet UILabel *label_QWSS;
...
@implementation JSLYTGYYJSCSCSBA_XiangQing_ViewController
...
- (void)viewDidLoad {
    ...
    [self add_GetHttp_PinJie:^NSString *{
        ...
        NSString *string_tableName = @"OA_YWGL_JSLYTG";
        NSString *string_flowName = @"jslytg";
...
- (void)add_View_Array:(NSArray *)array{
    ...
    self.label_TGZBH.text = dic_list[@"TGZID"];
    self.label_QWSS.text = dic_list[@"QWSS"];
