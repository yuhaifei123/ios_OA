//
//  BNSYTYNRSXTSB_XiangQing_ViewController.m
//  CZJSJOA
//
...
#import "BNSYTYNRSXTSB_XiangQing_ViewController.h"

@interface BNSYTYNRSXTSB_XiangQing_ViewController ()<UITextViewDelegate>
...
/** 热水系统替代方案 */
@property (weak, nonatomic) IBOutlet UILabel *label_RSXTDTFA;
...
@implementation BNSYTYNRSXTSB_XiangQing_ViewController
...
- (void)viewDidLoad {
    ...
    [self add_GetHttp_PinJie:^NSString *{
        ...
        NSString *string_tableName = @"OA_YWGL_TYNRS";
        NSString *string_flowName = @"tynrs";
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:
                         self.textView_CLHDYJ,@"SQPGLY",
                         self.tetxView_CFGLDYJ,@"SQPGDWYJ",
                         self.tetxView_CLDYJ,@"ZNCSYJ",
...
- (void)add_View_Array:(NSArray *)array{
   ...
   // NSLog(@"%@",dic_list);
    ...
    self.label_RSXTDTFA.text = dic_list[@"DTFA"];

    self.textView_CLHDYJ.text = dic_list[@"SQPGLY"];
    self.tetxView_CFGLDYJ.text = dic_list[@"SQPGDWYJ"];
    self.tetxView_CLDYJ.text = dic_list[@"ZNCSYJ"];
