//
//  GCKCSJQYZZYJHCCS_XiangQing_ViewController.m
//  CZJSJOA
//
...
#import "GCKCSJQYZZYJHCCS_XiangQing_ViewController.h"

@interface GCKCSJQYZZYJHCCS_XiangQing_ViewController ()<UITextViewDelegate>
...
/** 核查情况 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_HCQK;
...
@implementation GCKCSJQYZZYJHCCS_XiangQing_ViewController
...
- (void)viewDidLoad {
    ...
    [self add_GetHttp_PinJie:^NSString *{
        ...
        NSString *string_tableName = @"OA_YWGL_KCYJHC";
        NSString *string_flowName = @"kcyjhc";
