//
//  GCKCSJQYZZYJHCCS_List_ViewController.m
//  CZJSJOA
//
//  Created by 虞海飞 on 16/5/4.
//  Copyright © 2016年 薛伟俊. All rights reserved.
//
#pragma  mark -- 工程勘察设计企业资质业绩核查初审
#import "GCKCSJQYZZYJHCCS_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface GCKCSJQYZZYJHCCS_List_ViewController ()

@end

@implementation GCKCSJQYZZYJHCCS_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_KCYJHC";//查询表名
    self.FLOWNAME = @"kcyjhc";
    self.PageIndex = @"1";
    self.segueId = @"GCKCSJQYZZYJHCCS";
