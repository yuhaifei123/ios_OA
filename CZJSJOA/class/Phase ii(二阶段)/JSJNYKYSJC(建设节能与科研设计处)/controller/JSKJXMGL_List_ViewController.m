//
//  JSKJXMGL_List_ViewController.m
//  CZJSJOA
//
...
#import "JSKJXMGL_List_ViewController.h"
#import "AllList_TableViewCell.h"
@interface JSKJXMGL_List_ViewController ()

@end

@implementation JSKJXMGL_List_ViewController
static NSString *CELLID = @"ALLLIST";
- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_KJXMSB";//查询表名
    self.FLOWNAME = @"kjxmsb";
    self.PageIndex = @"1";//页数
    self.segueId = @"JSKJXMGL";
    //设置参数
