//
//  QRXZXKSXSPLZ_LIst_ViewController.m
//  CZJSJOA
//
...
#import "QRXZXKSXSPLZ_LIst_ViewController.h"
#import "AllList_TableViewCell.h"

@interface QRXZXKSXSPLZ_LIst_ViewController ()

@end

@implementation QRXZXKSXSPLZ_LIst_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_LSJDGL";//查询表名
    self.FLOWNAME = @"lsjdgl";
    self.PageIndex = @"1";//页数
    self.segueId = @"QRXZXKSXSPLZ";
    //设置参数
