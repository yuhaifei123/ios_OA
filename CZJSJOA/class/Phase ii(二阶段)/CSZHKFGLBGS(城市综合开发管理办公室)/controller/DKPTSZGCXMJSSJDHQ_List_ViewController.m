//
//  DKPTSZGCXMJSSJDHQ_List_ViewController.m
//  CZJSJOA
//
...
#import "DKPTSZGCXMJSSJDHQ_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface DKPTSZGCXMJSSJDHQ_List_ViewController ()

@end

@implementation DKPTSZGCXMJSSJDHQ_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_YJSJDHQ";//查询表名
    self.FLOWNAME = @"jysjdhq";
    self.PageIndex = @"1";//页数
    self.segueId = @"DKPTSZGCXMJSSJDHQ";
    //设置参数
