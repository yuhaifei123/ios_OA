...
#import "GFJNGL_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface GFJNGL_List_ViewController ()

@end

@implementation GFJNGL_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_GFJNGL";//查询表名
    self.FLOWNAME = @"gfjngl";
    self.PageIndex = @"1";//页数
    self.segueId = @"GFJNGL";
    //设置参数
