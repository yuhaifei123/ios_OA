//
//  JFSYBAHQ_List_ViewController.m
//  CZJSJOA
//
...
#import "JFSYBAHQ_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface JFSYBAHQ_List_ViewController ()

@end

@implementation JFSYBAHQ_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_JFSYHQ";//查询表名
    self.FLOWNAME = @"jfsyhq";
    self.PageIndex = @"1";//页数
    self.segueId = @"JFSYBAHQ";
    //设置参数
