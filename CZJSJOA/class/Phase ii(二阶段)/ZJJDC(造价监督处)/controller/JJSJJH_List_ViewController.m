...
//
#pragma  mark -- 经济审计计划
#import "JJSJJH_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface JJSJJH_List_ViewController ()

@end

@implementation JJSJJH_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_JJSJJH";//查询表名
    self.FLOWNAME = @"jjsjjh";
    self.PageIndex = @"1";//页数
    self.segueId = @"JJSJJH";
    //设置参数
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    allList_TableViewCell.label_Title.text = [NSString stringWithFormat:@"%@",dic[@"TITLE"]];
