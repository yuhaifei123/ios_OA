...
//
#pragma  mark --  经责审计通知书
#import "JZSJTZS_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface JZSJTZS_List_ViewController ()

@end

@implementation JZSJTZS_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_SJTZS";//查询表名
    self.FLOWNAME = @"sjtzs";
    self.PageIndex = @"1";//页数
    self.segueId = @"JZSJTZS";
    //设置参数
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    allList_TableViewCell.label_Title.text = [NSString stringWithFormat:@"%@",dic[@"SJSX"]];
