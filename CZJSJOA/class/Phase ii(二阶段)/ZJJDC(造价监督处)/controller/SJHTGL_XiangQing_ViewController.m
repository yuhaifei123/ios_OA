//
//  SJHTGL_XiangQing_ViewController.m
//  CZJSJOA
//
...
//原生态 双选人  BBBB
#pragma  mark -- 审计合同管理
#import "SJHTGL_XiangQing_ViewController.h"
#import "LPPopupListView.h"
#import "RenWuZhuanXie_SelectMen_TableViewController.h"

@interface SJHTGL_XiangQing_ViewController ()<UITextViewDelegate,LPPopupListViewDelegate>

/** 合同编号 */
@property (weak, nonatomic) IBOutlet UILabel *label_HTBH;
/** 合同名称 */
@property (weak, nonatomic) IBOutlet UILabel *label_HTBC;
/** 经办人 */
@property (weak, nonatomic) IBOutlet UILabel *label_JBR;
/** 日期 */
@property (weak, nonatomic) IBOutlet UILabel *label_RQ;
...
/** 合同内容 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_HTNR;
/** 被审计单位*/
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_BSJDW;
/** 工程造价监督处 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_GCZJCDC;
/** 计财处 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_JCC;
/** 法规处 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_FGC;
/** 纪委处意室 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_JWCYS;
/** 分管领导意见 */
...
@implementation SJHTGL_XiangQing_ViewController
...
- (void)viewDidLoad {
    ...
    [self add_GetHttp_PinJie:^NSString *{
        ...
        NSString *string_tableName = @"OA_YWGL_SJHT";
        NSString *string_flowName = @"sjht";
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    if (![self.string_BZ isEqualToString:@"b08"] && [self.dic_AllList[@"STATE"] isEqualToString:@"0"]) {
    ...
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:
                         self.textView_HTNR,@"CLOBTEXT1",
                         self.textView_BSJDW,@"BSJDWYJ",
                         self.textView_GCZJCDC,@"GCZJCYJ",
                         self.textView_JCC,@"JCCYJ",
                         self.textView_FGC,@"FGCYJ",
                         self.textView_JWCYS,@"JWJCSYJ",
    ...
    self.textView_HTNR.delegate = self;
    self.textView_BSJDW.delegate = self;
    self.textView_GCZJCDC.delegate = self;
    self.textView_JCC.delegate = self;
    self.textView_FGC.delegate = self;
    self.textView_JWCYS.delegate = self;
...
- (void)add_View_Array:(NSArray *)array{
    ...
    self.label_HTBH.text = dic_list[@"HTBH"];
    self.label_HTBC.text = dic_list[@"HTMC"];
    self.label_JBR.text = dic_list[@"NGR"];
    self.label_RQ.text = dic_list[@"NRTIME"];

    self.textView_HTNR.text = dic_list[@"HTNR"];
    self.textView_BSJDW.text = dic_list[@"BSJDWYJ"];
    self.textView_GCZJCDC.text = dic_list[@"GCZJCYJ"];
    self.textView_JCC.text = dic_list[@"JCCYJ"];
    self.textView_FGC.text = dic_list[@"FGCYJ"];
    self.textView_JWCYS.text = dic_list[@"JWJCSYJ"];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSDictionary *dic = dic = [[NSDictionary alloc] initWithObjectsAndKeys:@"6",@"type",@"sjht",@"rolename",nil];
...
-(void) add_Process{
    ...
    if ([self.string_BZ isEqualToString:@"b08"]) {
...
- (BOOL)textViewShouldBeginEditing:(UITextView *)textView{
    ...
    if (arrray.count < 1) {
        ...
        if ([string_DicKey isEqualToString:@"JSDWYJ"] && [self.string_BZ isEqualToString:@"b08"]) {
            string_DicKey = @"FGLD";
        }
