...
//
#pragma  mark -- 审计事项管理
#import "SJSXGL_List_ViewController.h"
#import "AllList_TableViewCell.h"
@interface SJSXGL_List_ViewController ()

@end

@implementation SJSXGL_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_SJSXHQ";//查询表名
    self.FLOWNAME = @"sjsxhq";
    self.PageIndex = @"1";//页数
    self.segueId = @"SJSXGL";
    //设置参数
