...
//
#pragma  mark -- 审计报告传阅
#import "SJBBCY_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface SJBBCY_List_ViewController ()

@end

@implementation SJBBCY_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_SJBG";//查询表名
    self.FLOWNAME = @"sjbg";
    self.PageIndex = @"1";//页数F
    self.segueId = @"SJBBCY";
    //设置参数
