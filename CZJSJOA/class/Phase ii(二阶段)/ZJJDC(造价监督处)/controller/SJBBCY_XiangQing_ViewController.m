//
//  SJBBCY_XiangQing_ViewController.m
//  CZJSJOA
//
...
//
#pragma  mark -- 审计报告传阅
#import "SJBBCY_XiangQing_ViewController.h"
#import "LPPopupListView.h"
#import "RenWuZhuanXie_SelectMen_TableViewController.h"

@interface SJBBCY_XiangQing_ViewController ()<UITextViewDelegate,LPPopupListViewDelegate,RenWuZhuanXie_SelectMen_TableViewControllerDelegate>

/** 编号 */
@property (weak, nonatomic) IBOutlet UILabel *label_BH;
/** 项目名称 */
@property (weak, nonatomic) IBOutlet UILabel *label_XMBC;
/** 审计单位 */
@property (weak, nonatomic) IBOutlet UILabel *label_SJDW;
/** 审计时间 */
@property (weak, nonatomic) IBOutlet UILabel *label_SJSJ;
...
/** 审计概况 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_SJGK;
/** 备注 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_BZ;
/** 实施单位意见 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_SSDWYJ;
/** 投融资主体意见 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_TRZZTYJYJ;
/** 计财处意见 */
...
@implementation SJBBCY_XiangQing_ViewController
...
- (void)viewDidLoad {
    ...
    [self add_GetHttp_PinJie:^NSString *{
        ...
        NSString *string_tableName = @"OA_YWGL_SJBG";
        NSString *string_flowName = @"sjbg";
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:
                         self.textView_SJGK,@"SJGK",
                         self.textView_BZ,@"BZ",
                         self.textView_SSDWYJ,@"SSDWYJ",
                         self.textView_TRZZTYJYJ,@"TRZZTYJ",
    ...
    self.self.dic_AllLianXi = [NSDictionary dictionaryWithObjectsAndKeys:
                         self.textView_SJGK,@"SJGK",
                         self.textView_BZ,@"BZ",
                         self.textView_SSDWYJ,@"SSDWYJ",
                         self.textView_TRZZTYJYJ,@"TRZZTYJ",
    ...
    self.textView_SJGK.delegate = self;
    self.textView_BZ.delegate = self;
    self.textView_SSDWYJ.delegate = self;
    self.textView_TRZZTYJYJ.delegate = self;
...
- (void)add_View_Array:(NSArray *)array{
    ...
    self.label_XMBC.text = dic_list[@"XMMC"];
    self.label_SJDW.text = dic_list[@"SJDW"];
    self.label_SJSJ.text = dic_list[@"SJSJ"];

    self.textView_SJGK.text = dic_list[@"SJGK"];
    self.textView_BZ.text = dic_list[@"BZ"];
    self.textView_SSDWYJ.text = dic_list[@"SSDWYJ"];
    self.textView_TRZZTYJYJ.text = dic_list[@"TRZZTYJ"];
    ...
    if (self.dic_XiaoShouXuanRen != nil) {
        ...
        //是没有选择小手时
        if ([dic_list[@"FGLDYJ"] isEqualToString:@""]) {

            NSUserDefaults *as = [NSUserDefaults standardUserDefaults];
            NSString *name = [as stringForKey:@"username"];
            self.textView_FGLDYJ.text = [NSString stringWithFormat:@"%@ %@",name,[ChangYong_NSObject DanQianTime]];
        }
        else{
             self.textView_FGLDYJ.text = dic_list[@"FGLDYJ"];
        }
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    NSDictionary *dic = dic = [[NSDictionary alloc] initWithObjectsAndKeys:@"6",@"type",@"sjbg",@"rolename",nil];
...
-(void) add_Process{
        ...
        if ([self.liuChenBean.bz isEqualToString:@"b07"]) {
            ...
            self.liuChenBean.spyj = [NSString stringWithFormat:@"%@\r\n%@",self.textView_FGLDYJ.text,self.array_spyj[0]];
            self.liuChenBean.spyjColumn = @"FGLDYJ";
        }
        else if ([self.liuChenBean.bz isEqualToString:@"b04"]){

            self.liuChenBean.spyj = self.textView_TRZZTYJYJ.text;
            self.liuChenBean.spyjColumn = @"TRZZTYJ";
        }
        else{
