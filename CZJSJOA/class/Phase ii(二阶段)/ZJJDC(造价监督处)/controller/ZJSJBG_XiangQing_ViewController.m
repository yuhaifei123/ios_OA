//
//  ZJSJBG_XiangQing_ViewController.m
//  CZJSJOA
//
...
//
#pragma  mark -- 经责审计报告
#import "ZJSJBG_XiangQing_ViewController.h"
#import "LPPopupListView.h"
#import "RenWuZhuanXie_SelectMen_TableViewController.h"

@interface ZJSJBG_XiangQing_ViewController ()<UITextViewDelegate,LPPopupListViewDelegate,RenWuZhuanXie_SelectMen_TableViewControllerDelegate>
...
/** 审计基本情况 */
@property (weak, nonatomic) IBOutlet Tool_TextView *textView_SJJBQK;
/** 备注 */
...
@implementation ZJSJBG_XiangQing_ViewController
...
- (void)viewDidLoad {
    ...
    [self add_GetHttp_PinJie:^NSString *{
        ...
        NSString *string_tableName = @"OA_YWGL_JJZRBG";
        NSString *string_flowName = @"jjzrbg";
...
- (void)add_View_Array:(NSArray *)array{
    ...
    self.textView_SJJBQK.text = dic_list[@"SJBQK"];
    ...
    self.textView_GCZJJDC.text = dic_list[@"ZJJDCYJ"];
