//
//  GSSCBGCY_List_ViewController.m
//  CZJSJOA
//
...
#import "GSSCBGCY_List_ViewController.h"
#import "AllList_TableViewCell.h"

@interface GSSCBGCY_List_ViewController ()

@end

@implementation GSSCBGCY_List_ViewController

- (void)viewDidLoad {

    self.FUNCTIONCODE = @"309901";
    self.TABLENAME = @"OA_YWGL_GSSCBGCY";//查询表名
    self.FLOWNAME = @"gsscbgcy";
    self.PageIndex = @"1";//页数
    self.segueId = @"GSSCBGCY";
    //设置参数
